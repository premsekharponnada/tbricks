...
protected:
  ...
  /// Create a multicast group description, in format useful for system calls.
  /// If greq param is NULL, just verify the passed addr/interface specs.
  int make_multicast_group_req (group_req *greq, // Put result here, if != NULL.
                                const ACE_INET_Addr &mcast_addr,
                                const ACE_TCHAR *net_if);

  /// Create a multicast source specific group description, in format useful for system calls.
  /// If greq param is NULL, just verify the passed addr/interface specs.
  int make_multicast_group_source_req (group_source_req *greq, // Put result here, if != NULL.
                                const ACE_INET_Addr &mcast_addr,
                                const ACE_INET_Addr &src_addr,
                                unsigned net_if_index);

  /// Get an interface index by its name (or address)
  int get_iface_index (const ACE_TCHAR *net_if,
