...
ACE_Atomic_Op<ACE_Thread_Mutex, long>::operator+= (long rhs)
{
  ...
  return (*add_fn_) (&this->value_, rhs);
...
{
  long value;
  ATOMIC_LOAD_RELAXED(value, &this->value_);
  return value;
}
...
#else /* WIN32 && ACE_HAS_INTERLOCKED_EXCHANGEADD */
  return static_cast<unsigned long> ((*add_fn_) (reinterpret_cast<volatile long *> (&this->value_), rhs));
#endif /* WIN32 && ACE_HAS_INTERLOCKED_EXCHANGEADD */
}
...
ACE_Atomic_Op<ACE_Thread_Mutex, unsigned long>::operator-= (unsigned long rhs)
{
  ...
  return static_cast<unsigned long> ((*add_fn_) (reinterpret_cast<volatile long *> (&this->value_), -l_rhs));
#endif /* WIN32 && ACE_HAS_INTERLOCKED_EXCHANGEADD */
}
