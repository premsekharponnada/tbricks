...
#if defined (linux)
  for (size_t idx=0; idx<ACE_FD_SET_ARRAY_SIZE; idx++)
    FD_ZERO (&this->mask_[idx]);
#else
  FD_ZERO (&this->mask_);
#endif /* linux */
  // #endif /* ACE_HAS_BIG_FD_SET */
...
#if defined (linux)
  return FD_ISSET (handle%FD_SETSIZE,
                   &this->mask_[handle/FD_SETSIZE])
    && this->size_ > 0;
