...
/* Platform does not support thr_getconcurrency/thr_setconcurrency functions,
   or their implementation is effectively a "no-op". This notably applies for
   Solaris >= 5.9. Note that if you build on Solaris 8 and run on Solaris 9+,
   you can encounter thread creation errors unless you rebuild on the target
   platform. */
/* #undef ACE_LACKS_THR_CONCURRENCY_FUNCS */
