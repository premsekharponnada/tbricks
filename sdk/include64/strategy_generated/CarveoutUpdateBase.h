...
class STRATEGY_EXPORT CarveoutUpdateBase : public Printable
{
protected:
    CarveoutUpdateBase();
    CarveoutUpdateBase(const CarveoutUpdateBase & value);
    CarveoutUpdateBase(CarveoutUpdateBase && value) noexcept;
    CarveoutUpdateBase & operator=(const CarveoutUpdateBase & value);
    CarveoutUpdateBase & operator=(CarveoutUpdateBase && value) noexcept;
    virtual ~CarveoutUpdateBase();
...
/** @cond PRIVATE */
public:
    CarveoutUpdateBase(const protocol::Carveout & value);
    CarveoutUpdateBase(std::shared_ptr<protocol::Carveout> && value);
