...
#include "strategy_generated/TradingBlockUpdateBase.h"
...
class STRATEGY_EXPORT TradingBlockBase : public Printable
{
protected:
    TradingBlockBase();
    TradingBlockBase(const TradingBlockBase & value);
    TradingBlockBase(TradingBlockBase && value) noexcept;
    TradingBlockBase & operator=(const TradingBlockBase & value);
    TradingBlockBase & operator=(TradingBlockBase && value) noexcept;
    virtual ~TradingBlockBase();
...
protected:
    void Merge(const TradingBlockUpdateBase & update);

/** @cond PRIVATE */
public:
    TradingBlockBase(const protocol::TradingBlock & value);
    TradingBlockBase(std::shared_ptr<protocol::TradingBlock> && value);
