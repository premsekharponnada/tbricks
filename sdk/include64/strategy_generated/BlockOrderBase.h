...
class STRATEGY_EXPORT BlockOrderBase : public Printable
{
protected:
    BlockOrderBase();
    BlockOrderBase(const BlockOrderBase & value);
    BlockOrderBase(BlockOrderBase && value) noexcept;
    BlockOrderBase & operator=(const BlockOrderBase & value);
    BlockOrderBase & operator=(BlockOrderBase && value) noexcept;
    virtual ~BlockOrderBase();
...
protected:
    void Merge(const BlockOrderUpdateBase & update);

/** @cond PRIVATE */
public:
    BlockOrderBase(const protocol::BlockOrder & value);
    BlockOrderBase(std::shared_ptr<protocol::BlockOrder> && value);
