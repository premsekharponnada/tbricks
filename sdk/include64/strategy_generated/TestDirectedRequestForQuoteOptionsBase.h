...
//
// TestDirectedRequestForQuoteOptionsBase object
//
//****************************************************************************
...
class STRATEGY_EXPORT TestDirectedRequestForQuoteOptionsBase : public Printable
{
protected:
    TestDirectedRequestForQuoteOptionsBase();
    TestDirectedRequestForQuoteOptionsBase(const TestDirectedRequestForQuoteOptionsBase & value);
    TestDirectedRequestForQuoteOptionsBase(TestDirectedRequestForQuoteOptionsBase && value) noexcept;
    TestDirectedRequestForQuoteOptionsBase & operator=(const TestDirectedRequestForQuoteOptionsBase & value);
    TestDirectedRequestForQuoteOptionsBase & operator=(TestDirectedRequestForQuoteOptionsBase && value) noexcept;
    virtual ~TestDirectedRequestForQuoteOptionsBase();
...
protected:
    void Merge(const TestDirectedRequestForQuoteOptionsBase & update);

/** @cond PRIVATE */
public:
    TestDirectedRequestForQuoteOptionsBase(const protocol::DirectedRequestForQuote & value);
    TestDirectedRequestForQuoteOptionsBase(std::shared_ptr<protocol::DirectedRequestForQuote> && value);
