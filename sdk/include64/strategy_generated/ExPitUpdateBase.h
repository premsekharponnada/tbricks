...
class STRATEGY_EXPORT ExPitUpdateBase : public Printable
{
protected:
    ExPitUpdateBase();
    ExPitUpdateBase(const ExPitUpdateBase & value);
    ExPitUpdateBase(ExPitUpdateBase && value) noexcept;
    ExPitUpdateBase & operator=(const ExPitUpdateBase & value);
    ExPitUpdateBase & operator=(ExPitUpdateBase && value) noexcept;
    virtual ~ExPitUpdateBase();
...
/** @cond PRIVATE */
public:
    ExPitUpdateBase(const protocol::Expit & value);
    ExPitUpdateBase(std::shared_ptr<protocol::Expit> && value);
