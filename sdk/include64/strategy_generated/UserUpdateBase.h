...
class STRATEGY_EXPORT UserUpdateBase : public Printable
{
protected:
    UserUpdateBase();
    UserUpdateBase(const UserUpdateBase & value);
    UserUpdateBase(UserUpdateBase && value) noexcept;
    UserUpdateBase & operator=(const UserUpdateBase & value);
    UserUpdateBase & operator=(UserUpdateBase && value) noexcept;
    virtual ~UserUpdateBase();
...
/** @cond PRIVATE */
public:
    UserUpdateBase(const protocol::User & value);
    UserUpdateBase(std::shared_ptr<protocol::User> && value);
