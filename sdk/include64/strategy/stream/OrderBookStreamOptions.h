...
/**
 * OrderBookStreamOption class, used for setting options for OrderBookStream stream.
 * @deprecated use OrderBook::Stream::Options instead. Deprecated in 2.12.0, will be removed in 2.13.0
 */
template <typename Filter_T, typename Throttle_T>
class OrderBookStreamOptions
{
public:
    OrderBookStreamOptions() : m_coalescing(true) {}
    ...
    /**
     * Setting the @p will make the OrderBook updates aggregated by price.
     * If number of levels is not specified, all OrderBook updates without any aggregations will be received.
     * @param level acts as a maximum number of returned levels
     *
     * <b>Example</b>
     *
     * There are bid orders 10@@10, 5@@10, 1@@10, 20@@9.90, 50@@9.80, 100@@9.70.
     *
    ...
    /**
     * Sets the minimum volume for a given depth levels.
     */
    ...
    /// @deprecated Deprecated in 2.14.0 use 'Set*()' and 'const Get*()' functions instead.
    [[deprecated(DEPRECATE_LINK)]] Volume & GetVolume() { return m_volume; }
