...
class STRATEGY_EXPORT Component::Stream : public tbricks::Stream
{
public:
    class IHandler;
    class Options;
...
/**
 * Component::Stream::IHandler class provides a callback interface to handle stream events.
 * @see Component::Stream
 */
class STRATEGY_EXPORT Component::Stream::IHandler : public tbricks::Stream::IHandler
{
public:
    virtual void HandleStreamOpen(const StreamIdentifier & /* stream */) {}
      ...
      */
    virtual void HandleComponent(const StreamIdentifier & stream, const Component & update) = 0;
    ...
    /**
      ...
      */
    virtual void HandleComponentInvalidate(const StreamIdentifier & stream, const ComponentIdentifier & id) = 0;
...
/**
 * Component::Stream::Options
 * @see Component::Stream
 */
class STRATEGY_EXPORT Component::Stream::Options : public Printable
{
public:
    Options();
    ~Options();
     ...
     * @return                          filter
     */
    Component::Stream::Filters::Filter GetFilter() const;
     ...
     * @param value                     filter
     */
    void SetFilter(const Component::Stream::Filters::Filter & value);
    /**
     * Get stream item ids.
     *
