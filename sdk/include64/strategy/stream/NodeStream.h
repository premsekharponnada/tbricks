...
class STRATEGY_EXPORT Node::Stream : public tbricks::Stream
{
public:
    class IHandler;
    class Options;
...
/**
 * Node::Stream::IHandler class provides a callback interface to handle stream events.
 * @see Node::Stream
 */
class STRATEGY_EXPORT Node::Stream::IHandler : public tbricks::Stream::IHandler
{
public:
    virtual void HandleStreamOpen(const StreamIdentifier & /* stream */) {}
      ...
      */
    virtual void HandleNode(const StreamIdentifier & stream, const Node & update) = 0;
    ...
    /**
      ...
      */
    virtual void HandleNodeInvalidate(const StreamIdentifier & stream, const NodeIdentifier & id) = 0;
 ...
 * @see Node::Stream
 */
class STRATEGY_EXPORT Node::Stream::Options : public Printable
{
public:
    Options();
    ~Options();
     ...
     * @return                          filter
     */
    Node::Stream::Filters::Filter GetFilter() const;
     ...
     * @param value                     filter
     */
    void SetFilter(const Node::Stream::Filters::Filter & value);
    /**
     * Get stream item ids.
     *
     * @return                          stream item ids
     */
    std::vector<NodeIdentifier> GetNodeIdentifiers() const;
     ...
     */
    void SetNodeIdentifiers(const std::vector<NodeIdentifier> & value);
