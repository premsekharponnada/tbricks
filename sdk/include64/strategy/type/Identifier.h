...
class STRATEGY_EXPORT Identifier : public AnyType
{
public:
    Identifier() = default;
    Identifier(const Uuid & value)
        : m_value(value)
    {}
    Identifier(const char * value)
        : m_value(value)
    {}
    Identifier(const types::UUID & value)
        : m_value(value)
    {}

    Identifier & operator = (const Uuid & value)
    { m_value = value; return *this; }

    Identifier & operator = (const types::UUID & value)
    { m_value = value; return *this; }
...
public:
    bool operator == (const Identifier & value) const
