...
class STRATEGY_EXPORT ServiceIdentifier : public AnyType
{
public:
    ServiceIdentifier() = default;
    ServiceIdentifier(const Uuid & value)
        : m_value(value)
    {}
    ServiceIdentifier(const char * value)
        : m_value(value)
    {}
    ServiceIdentifier(const types::UUID & value)
        : m_value(value)
    {}
    ServiceIdentifier(const Identifier & value)
        : m_value(value.GetUuid())
    {}

    ServiceIdentifier & operator = (const Uuid & value)
    { m_value = value; return *this; }

    ServiceIdentifier & operator = (const types::UUID & value)
    { m_value = value; return *this; }
...
public:
    bool operator == (const ServiceIdentifier & value) const
