...
class STRATEGY_EXPORT UserIdentifier : public AnyType
{
public:
    UserIdentifier() = default;
    UserIdentifier(const Uuid & value)
        : m_value(value)
    {}
    UserIdentifier(const char * value)
        : m_value(value)
    {}
    UserIdentifier(const types::UUID & value)
        : m_value(value)
    {}
    UserIdentifier(const Identifier & value)
        : m_value(value.GetUuid())
    {}

    UserIdentifier & operator = (const Uuid & value)
    { m_value = value; return *this; }

    UserIdentifier & operator = (const types::UUID & value)
    { m_value = value; return *this; }
...
public:
    bool operator == (const UserIdentifier & value) const
