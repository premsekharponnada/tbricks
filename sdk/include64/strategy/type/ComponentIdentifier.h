...
class STRATEGY_EXPORT ComponentIdentifier : public AnyType
{
public:
    ComponentIdentifier() = default;
    ComponentIdentifier(const Uuid & value)
        : m_value(value)
    {}
    ComponentIdentifier(const char * value)
        : m_value(value)
    {}
    ComponentIdentifier(const types::UUID & value)
        : m_value(value)
    {}
    ComponentIdentifier(const Identifier & value)
        : m_value(value.GetUuid())
    {}

    ComponentIdentifier & operator = (const Uuid & value)
    { m_value = value; return *this; }

    ComponentIdentifier & operator = (const types::UUID & value)
    { m_value = value; return *this; }
...
public:
    bool operator == (const ComponentIdentifier & value) const
