...
//
// StrategyByModifiedDateTimeFilter matches strategies by their modified date.
//****************************************************************************************
...
/**
 * StrategyByModifiedDateTimeFilter matches strategies modified starting from, until
 * or in a range of a specified date/time(s), inclusive.
 */
class STRATEGY_EXPORT StrategyByModifiedDateTimeFilter : public StrategyFilterCondition
{
public:
    /**
     * Constructor.
     *
     * Makes a filter to match all strategies modified in the specified time frame,
     ...
     */
    StrategyByModifiedDateTimeFilter(const DateTime & from, const DateTime & until) : m_impl(from, until) {}
...
protected:
    ...
    {
        strm << "<strategy by host modified date time filter>\n";
