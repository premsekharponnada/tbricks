...
//
// InstrumentStream::Filters::ByModifiedDateTimeFilter, matches updates of
...
/**
 * InstrumentStream::Filters::ByModifiedDateTimeFilter matches concrete
 * instrument instance updates, selected by instrument modified date and time range.
 */
class STRATEGY_EXPORT InstrumentStream::Filters::ByModifiedDateTimeFilter : public InstrumentStream::Filters::FilterCondition
{
public:
    /**
     * Constructor.
     *
     * Makes a filter to match all instruments modified in the specified timeframe,
...
protected:
    ...
    {
        strm << "<instrument by host modified date time filter>\n";
