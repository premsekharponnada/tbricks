...
//
// TradeByCreatedDateTimeFilter, selects trades by their creation date.
//****************************************************************************************
...
/**
 * TradeByCreatedDateTimeFilter matches trades created starting from, until
 * or in a range of a specified date/time(s), inclusive.
 */
class STRATEGY_EXPORT TradeByCreatedDateTimeFilter : public TradeFilterCondition
{
public:
    /**
     * Constructor.
     ...
     */
    TradeByCreatedDateTimeFilter(const DateTime & from, const DateTime & until) : m_impl(from, until) {}
...
protected:
    ...
    {
        strm << "<trade by host created date time filter>\n";
