...
//
// AuditableByModifiedDateTimeFilter, selects auditables by their modified date.
//****************************************************************************************
...
/**
 * AuditableByModifiedDateTimeFilter matches auditables modified starting from, until
 * or in a range of a specified date/time(s), inclusive.
 */
class STRATEGY_EXPORT AuditableByModifiedDateTimeFilter : public AuditableFilterCondition
{
public:
    /**
     * Constructor.
     *
     * Makes a filter to match all auditables modified in the specifed timeframe,
     ...
     */
    AuditableByModifiedDateTimeFilter(const DateTime & from, const DateTime & until) : m_impl(from, until) {}
